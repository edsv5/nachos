...
class Thread {
  ...
  public:
    ...
    // Nuevo: Setters y getters de archivosAbiertosPorThread

    int getArchivosAbiertosPorThread(){ return archivosAbiertosPorThread; }

    void setArchivosAbiertosPorThread(int n){ archivosAbiertosPorThread = n; }

    // Nuevo: Setters y Getters para el idThread

    int getIdThread(){ return idThread; }

    void setIdThread(int id){ idThread = id; }
  ...
  private:
    ...
    // Nuevo: El thread debe tener un contador con la cantidad de archivos abiertos que tenga

    int archivosAbiertosPorThread;
