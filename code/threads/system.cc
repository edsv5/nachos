...
//Agregado: Inicialización del BitMap global
BitMap* mapMemoria = new BitMap(32); // Se inicializa con 32 bits, 1 por página

// Inicializa map de semáforos

std::map<int,Semaphore* > *mapSemaforosNachos = new std::map<int,Semaphore* > ;

// Inicializa contador de semáforos

int cantidadSemaforosNachos;
...
Initialize(int argc, char **argv)
{
    ...
    bool randomYield = false;
		//consoleS = new Semaphore("Consola", 0); // Semaforo para la consola
...
// 2007, Jose Miguel Santos Espino
    ...
    // Inicializar openFilesTable
    // TODO: Preguntar por qué da undefined reference to aquí
